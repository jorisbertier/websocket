...
function Modal({ message, show, onClose }) {
    ...
    return (
        <div className="fixed bottom-6 right-6 z-50 bg-white border border-gray-300 shadow-lg rounded-lg w-80 p-4 animate-fade-in-out">
            ...
            <div className="w-32 h-32 bg-blue-500 animate-bounce"></div>
